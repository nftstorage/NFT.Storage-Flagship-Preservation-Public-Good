  ...
  [903],
  {
    6737: (e, t, n) => {
        ...
        return (0, o.useMemo)(() => {
          const e =
            ...
            (function (e) {
              return g(e).map((e) => {
                let {
                  props: { value: t, label: n, attributes: r, default: i },
                } = e;
                return { value: t, label: n, attributes: r, default: i };
              });
            })(n);
          return (
            (function (e) {
              const t = (0, d.X)(e, (e, t) => e.value === t.value);
              if (t.length > 0)
                throw new Error(
        ...
        const { defaultValue: t, queryString: n = !1, groupId: r } = e,
          ...
          [a, s] = (0, o.useState)(() =>
            (function (e) {
              ...
              if (t) {
                if (!f({ value: t, tabValues: n }))
                  throw new Error(
                    `Docusaurus error: The <Tabs> has a defaultValue "${t}" but none of its children has the corresponding value. Available values are: ${n.map((e) => e.value).join(", ")}. If you intend to show no default tab, use defaultValue={null} instead.`,
                  );
                return t;
              }
          ...
          m = (() => {
            const e = l ?? d;
            return f({ value: e, tabValues: i }) ? e : null;
          })();
        (0, c.A)(() => {
          m && s(m);
        }, [m]);
      ...
      function v(e) {
        ...
        const c = [],
          { blockElementScrollPositionUntilNextRender: u } = (0, s.a_)(),
          d = (e) => {
          ...
          h = (e) => {
            ...
            switch (e.key) {
              case "Enter":
                ...
                break;
              case "ArrowRight": {
                const n = c.indexOf(e.currentTarget) + 1;
                t = c[n] ?? c[0];
                break;
              }
              case "ArrowLeft": {
          ...
          children: l.map((e) => {
            ...
            return (0, r.jsx)(
              "li",
              {
                ...
                onClick: d,
                ...o,
                className: (0, a.A)("tabs__item", x.tabItem, o?.className, {
      ...
      function j(e) {
        let { lazy: t, children: n, selectedValue: i } = e;
        const a = (Array.isArray(n) ? n : [n]).filter(Boolean);
        if (t) {
          const e = a.find((e) => e.props.value === i);
          return e
        ...
        return (0, r.jsx)("div", {
          ...
          children: a.map((e, t) =>
            (0, o.cloneElement)(e, { key: t, hidden: e.props.value !== i }),
          ),
        });
      }
      function w(e) {
        const t = m(e);
        return (0, r.jsxs)("div", {
          className: (0, a.A)("tabs-container", x.tabList),
          children: [
            (0, r.jsx)(v, { ...e, ...t }),
            (0, r.jsx)(j, { ...e, ...t }),
          ],
      ...
      function k(e) {
        const t = (0, y.A)();
        return (0, r.jsx)(w, { ...e, children: g(e.children) }, String(t));
      }
      const T = { tabItem: "tabItem_Ymn6" };
      function N(e) {
        let { children: t, hidden: n, className: i } = e;
        return (0, r.jsx)("div", {
          role: "tabpanel",
          className: (0, a.A)(T.tabItem, i),
          hidden: n,
          children: t,
        });
      }
      const S = { sidebar_position: 1 },
        ...
        F = {
          ...
          next: { title: "How To", permalink: "/v1/docs/category/how-to" },
        },
        _ = {},
        V = [
          { value: "Getting Started", id: "getting-started", level: 2 },
          { value: "Creating an Account", id: "creating-an-account", level: 2 },
          { value: "Buy Some Storage", id: "buy-some-storage", level: 2 },
          {
            value: "Uploading Tokens via the Website",
            id: "uploading-tokens-via-the-website",
            level: 2,
          },
        ];
      function C(e) {
        ...
        return (0, r.jsxs)(r.Fragment, {
          children: [
            (0, r.jsx)(t.h1, { id: "quickstart", children: "Quickstart" }),
            "\n",
            (0, r.jsx)(t.p, {
              children:
                "NFT.Storage is designed to enable the long-term preservation of NFT data in the decentralized, verifiable Filecoin Network, charging only a small one-time fee. By storing in the Filecoin Network, we strive to ensure that your NFTs are accessible, safeguarding your digital assets without recurring costs.",
            ...
            (0, r.jsxs)(t.p, {
              children: [
                (0, r.jsx)(t.strong, {
                  children: "Ready to get started using NFT.Storage right now?",
                }),
                " Get up and running in minutes by following this quickstart guide. In this guide, we'll walk through the following steps:",
              ],
            }),
            "\n",
            (0, r.jsxs)(t.ul, {
              children: [
                ...
                (0, r.jsx)(t.li, {
                  children: (0, r.jsx)(t.a, {
                    href: "#buy-some-storage",
                    children: "Buy Some Storage",
                  }),
                }),
                "\n",
                (0, r.jsx)(t.li, {
                  children: (0, r.jsx)(t.a, {
                    href: "#uploading-tokens-via-the-website",
                    children: "Uploading Tokens via the Website",
                  }),
                }),
                "\n",
              ],
                  ...
                  children: [
                    ...
                    (0, r.jsxs)(t.li, {
                      children: [
                        "Visit the ",
                        (0, r.jsx)(t.a, {
                          href: "https://nft-weld-seven.vercel.app/login",
                    ...
                    "\n",
                    (0, r.jsx)(t.li, {
                      children: 'Click "Log in with GitHub" option.',
                    }),
                    "\n",
                    (0, r.jsx)(t.li, {
                      children:
                    ...
                    "\n",
                    (0, r.jsx)(t.li, {
                      children: "Log in to your GitHub account if prompted.",
                    }),
                    "\n",
                    (0, r.jsx)(t.li, {
                      children:
                        "Authorize NFT.Storage to access your GitHub account.",
                    }),
                    "\n",
                    (0, r.jsx)(t.li, {
                      children:
                        "You will be redirected back to NFT.Storage upon successful authentication.",
                    }),
                    "\n",
                  ],
                }),
            ...
            (0, r.jsxs)(t.ol, {
              children: [
                ...
                (0, r.jsx)(t.li, {
                  children:
                    'Click on the "Get more storage" option in the dashboard navigation menu.',
                }),
                "\n",
                (0, r.jsx)(t.li, {
                  children: "Enter the amount of storage you want to buy.",
                }),
                "\n",
                (0, r.jsx)(t.li, {
                  children:
                ...
                (0, r.jsx)(t.li, {
                  children:
                    "Follow the prompts to complete the transaction securely. You may be required to enter payment details and confirm the purchase.",
                }),
                "\n",
                (0, r.jsx)(t.li, {
                  children:
                    "With your storage successfully purchased, you can now proceed to upload tokens to NFT.Storage without any restrictions.",
                }),
                "\n",
              ],
            }),
            ...
            (0, r.jsxs)(t.ol, {
              children: [
                ...
                (0, r.jsxs)(t.li, {
                  children: [
                    "Click on the ",
                    (0, r.jsx)(t.strong, { children: "Dashboard" }),
                ...
                (0, r.jsxs)(t.li, {
                  children: [
                    "Look for the ",
                    (0, r.jsx)(t.strong, { children: "Add Items" }),
                    " section within the dashboard.",
                  ],
                }),
                "\n",
                (0, r.jsx)(t.li, {
                  children:
                    "Fill in the smart contract address and select the chain on which contract is deployed.",
                }),
                "\n",
                (0, r.jsxs)(t.li, {
                  children: [
                    "Click or drag-and-drop CSV or JSON file directly into the designated area.\n",
                    (0, r.jsx)(t.img, {
                      alt: "Upload Modal",
                      src: n(625).A + "",
                      width: "1920",
              ...
              children: [
                ...
                (0, r.jsxs)(t.li, {
                  children: [
                    "\n",
                    (0, r.jsx)(t.p, {
                      children: "Each row represents a token.",
                    }),
                    "\n",
                  ],
                }),
                ...
                (0, r.jsxs)(t.li, {
                  children: [
                    "\n",
                    (0, r.jsx)(t.p, { children: "Example structure:" }),
                    "\n",
                    (0, r.jsx)(t.pre, {
            ...
            (0, r.jsxs)(t.ol, {
              ...
              children: [
                ...
                (0, r.jsx)(t.li, {
                  children:
                    "For JSON format, ensure your data follows this structure:",
                }),
                "\n",
              ],
            }),
            ...
            (0, r.jsxs)(t.ol, {
              ...
              children: [
                ...
                (0, r.jsxs)(t.li, {
                  children: [
                    "Once you've selected the files and provided necessary information, initiate the upload process by clicking on ",
                    (0, r.jsx)(t.strong, { children: "Upload" }),
                  ],
                }),
                "\n",
              ],
    ...
    625: (e, t, n) => {
      n.d(t, { A: () => r });
      const r =
        n.p + "assets/images/upload-modal-5391af55ef72824df681223befb91c45.png";
    },
    8453: (e, t, n) => {
      n.d(t, { R: () => a, x: () => s });
      var r = n(6540);
